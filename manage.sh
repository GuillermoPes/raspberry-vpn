...
change_adguard_password() {
    ...
    echo -e "${YELLOW}Si olvidaste la contraseña y no puedes acceder, puedes restablecerla editando el archivo de configuración 'AdGuardHome.yaml' en el volumen de AdGuard Home y eliminando la línea 'password:'. Luego reinicia el contenedor."
}
